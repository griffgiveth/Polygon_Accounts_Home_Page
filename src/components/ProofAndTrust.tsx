      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <blockquote className="text-lg text-gray-700 italic">
              "Polygon Accounts made onboarding our ETH Denver attendees seamless. 
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 opacity-60">
          <div className="flex items-center">
            <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg flex items-center justify-center mr-3">
              <span className="text-white font-bold text-sm">P</span>
            </div>
            <span className="text-gray-700 font-semibold">Polygon</span>
          </div>
